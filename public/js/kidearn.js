    ...
    kidearnTiltElm.each(function () {
      ...
      try {
        ...
        if (options === undefined || options === null) {
          // No options provided - use empty object
          parsedOptions = {};
          ...
          // Fallback to empty object for other cases
          parsedOptions = {};
        }
        
        // Initialize tilt with the parsed options
        let kidearnTilt = self.tilt(parsedOptions);
        
      } catch (error) {
        console.error("Failed to initialize tilt effect:", error);
        // Fallback to default tilt with empty options
        self.tilt({});
      }
    });
  }
